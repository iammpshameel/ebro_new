...
def detail_view_deals(request,id):
	if request.method == 'POST':
		...
		context = {'user':user,'user_deals_list':user_deals_list}
...
def detail_view_jobs(request,id):
	if request.method == 'POST':
		...
		context = {'user':user,'user_jobs_list':user_jobs_list}
...
def detail_view_products(request,id):
	if request.method == 'POST':
		...
		context = {'user':user,'user_products_list':user_products_list,'user_products_attach_list':user_products_attach_list}
